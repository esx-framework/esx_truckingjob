...
Config.dropOffPoints = {
    ...
    cars = {
        ...
        vector4(236.5334, -780.8195, 30.6600, 156.5012),
        vector4(-315.9659, -889.0975, 31.0766, 77.2247),
        vector4(732.8381, 4174.0596, 40.7092, 177.6614),
        vector4(-20.1213, -2688.6733, 6.0000, 181.4466),
        vector4(3858.6475, 4405.6226, 3.3478, 246.6750),
        vector4(489.8258, -1332.6660, 29.3331, 280.4969),
    },
    millitary = {
        vector4(-2323.0359, 3396.2832, 30.6740, 235.2778),
        vector4(1861.1392, 2712.1089, 45.9254, 23.7838),
        vector4(478.6091, -1021.8411, 28.0122, 271.0367),
        vector4(163.1508, -3092.2925, 5.9381, 94.0762)
    }
}
...
Config.pickupPoints = {
    ...
    cars = {
        ...
        vector4(403.2607, -1644.2954, 29.2919, 231.6691),
        vector4(-197.1433, 6218.2539, 31.4893, 137.6240),
        vector4(1740.2861, 3719.7222, 34.0292, 32.6815)
    },
    millitary = {
        vector4(-1546.1902, 2753.0972, 17.8250, 232.3705),
        vector4(282.7241, -3154.4417, 5.7916, 3.0176),
        vector4(262.4423, -2827.8008, 6.0202, 185.1778)
    }
}
