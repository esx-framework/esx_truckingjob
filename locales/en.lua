Locales['en'] = {
  ...
  ["penalties_total"] = "Total Penalties: %s%s",
  ["penalties_recieved"] = "Recieved a %s%s penality for %s",
  ["penalties_onPavement"] = "driving on pavement",
  ["penalties_ranRedLight"] = "running a red light",
  ["penalties_hitVehicle"] = "hitting a vehicle",
  ["penalties_againstTraffic"] = "drving against traffic",
  ["penalties_damageTruck"] = "damaging the truck",
  ["penalties_damageTrailer"] = "damaging the trailer",
  ["penalties_speeding"] = "speeding",
